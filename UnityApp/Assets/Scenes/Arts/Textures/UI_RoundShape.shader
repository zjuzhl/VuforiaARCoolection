Shader "UI/RoundShape"
{
    Properties
    {
        ...
        _StencilComp ("Stencil Comparison", Float) = 8 // 默认值为 Always
        _StencilReadMask ("Stencil Read Mask", Float) = 255 // 添加此行
        _StencilWriteMask ("Stencil Write Mask", Float) = 255
        _ColorMask ("Color Mask", Float) = 15 // RGBA (默认值为15，表示启用所有通道)
    }

...
namespace Piglet.UnityGLTF.Extensions
{
	public static class SchemaExtensions
	{
		...
		{
			// In glTF, color factors (i.e. `baseColorFactor`, `emissiveFactor`,
			// `diffuseFactor`) are stored as linear values. However, Unity
			// shaders expect the values for `Color` shader properties to be given in
			// Gamma space, regardless of whether the project is set to "Gamma" or
			// "Linear" under Edit -> Project Settings... -> Player
